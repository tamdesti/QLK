...
namespace QuanLyKho
{
    public partial class frmInChiTietXuatKhoTheoSanPham : Form
    {
        //Nếu theo khách hàng thì 
        public frmInChiTietXuatKhoTheoSanPham(DataGridView dg, DateTime dtFrom, DateTime dtTo, string TenSanPham)
        {
            InitializeComponent();
            GetData(dg, dtFrom, dtTo, TenSanPham);
        }
